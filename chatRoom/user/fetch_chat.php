<?php
	...
	if(isset($_POST['fetch'])){
		...
		<div>
			...
			<span style="font-size:12px; font:message-box; color:darkmagenta; position:relative; top:-2px; left:50px;"><strong><?php echo $row['uname']; ?></strong><strong>: <?php echo $row['message']; ?></strong></span><br>
		</div>
